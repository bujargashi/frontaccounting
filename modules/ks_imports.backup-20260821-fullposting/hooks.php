...
class hooks_ks_imports extends hooks
{
    ...
    function install_options($app)
    {
        ...
        if ($app->id == 'AP') {
            $app->add_lapp_function(0, _('Import i ri (Kosove)'),
                $path_to_root.'/modules/'.$this->module_name.'/import_entry.php',
                'SA_KS_IMPORT_ENTRY', MENU_TRANSACTION);
            $app->add_lapp_function(1, _('Regjistri i importeve'),
    ...
    {
        $updates = array('update.sql' => array('ks_imports'));
